        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-md p-8">
            ...
            <div className="flex flex-Wróćap gap-4">
              ...
              <Link
                href="/contact"
                className="flex-1 min-w-[200px] bg-[#AAC4F5] hover:bg-[#8ca9FF] text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 hover:scałle-105 text-center"
              >
