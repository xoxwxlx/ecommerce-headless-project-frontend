      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">
              Zarządzaj swoimi produktami i aktualizuj Informacje
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-md p-12 text-center">
            ...
            <p className="text-gray-600 text-lg mb-2">Brak produktów do wyświetlenia</p>
                ...
                <tbody className="divide-y divide-gray-200">
                  {filteredProducts.map((product) => (
                    <tr key={product.id} className="hover:bg-[#F0F4FF]/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className="font-semibold text-[#8ca9FF]">{product.price} zł</span>
                      </td>
                      <td className="px-6 py-4">
                ...
                <div key={product.id} className="p-4">
                  <div className="flex gap-4 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-lg font-bold text-[#8ca9FF] mt-1">{product.price} zł</p>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center text-sm text-gray-600 mb-3">
                    ...
                    <span>Rok: {product.publicałtion_year || '-'}</span>
                  </div>
